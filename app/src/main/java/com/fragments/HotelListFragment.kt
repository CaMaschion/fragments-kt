...
class HotelListFragment : ListFragment(), HotelListView {
    ...
    override fun onListItemClick(l: ListView, v: View, position: Int, id: Long) {
        ...
        //será invocado quando o usuário clicar em um item da lista, e nele é checado se a activity(onde esse fragment está sendo exibido) implementa a interface OnHotelClickListener
    }
    
    interface OnHotelClickListener {
        fun onHotelClick(hotel: Hotel)
        //a activity que usar esse fragment deverá implementar essa interface caso queira ser notificada quando um item da lista for clicado
    }
